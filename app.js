...
//az önce indirdiğim MySQl eklentisini koda dahil edicez
const mysql = require ('mysql2');
//MySQL veri tabanımıza bağlanmak için gerekli bilgileri gireceğiz
...
password: process.env.HC_PASSWORD, //şifre kısmı
database: process.env.HC_NAME // ilk adımda oluşturduğum veritabanımın ismii
});
//Bağlantıyı resmi olarak başlatıyoruz.
...
// Veri tabanına kitapları getirecek SQL sorgumuzu çalıştırıyoruz.
